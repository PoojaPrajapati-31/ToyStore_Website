            ...
            <div class="container ">
              <div class="row">
                <div class="col-md-6 ">
                  <div class="detail-box">
                    <h1>
                     We don't really grow up.<br>
                     Our toys change with time.
                    </h1>
                    <p>
      ...
      <div class="row">
        ...
        <div class="col-md-5">
          <div class="detail-box">
            ...
            <a href="http://localhost/toy/home.php?option=about">
              Read More
            </a>
          </div>
        </div>
    ...
    <div class="container container-bg">
      <div class="row">
        ...
        <div class="col-md-6 col-lg-5 px-0">
            ...
            <div>
            <a href="http://localhost/toy/home.php?option=contact"><input type="text" placeholder="Name" />
            </div>
            <div>
            <a href="http://localhost/toy/home.php?option=contact"><input type="email" placeholder="Email" />
            </div>
            <div>
            <a href="http://localhost/toy/home.php?option=contact"><input type="text" placeholder="Phone" />
            </div>
            <div>
            <a href="http://localhost/toy/home.php?option=contact"><input type="text" class="message-box" placeholder="Question" />
            </div>
            <div class="d-flex ">
            <a href="http://localhost/toy/home.php?option=contact"><input type="submit" name="submit" value="Send" />
            </div>
            </div>
