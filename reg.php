...
if (isset($_POST['submit'])) {
  ...
  if ($r == 1) {
    ...
    header("location:/reg.php"); //reg page
  } else {
    ...
    if (!mysqli_query($conn, $sql2)) {
      ...
      echo "<script type='text/javascript'>alert('$message');</script>";
      header("location:/index.php?option=login"); //login page
    }
  }
}
?>
  ...
  <div class="hero_area">
    ...
    <body>
      ...
      <div class="signup-form" style="margin-top:70px">
        ...
        <div align="center"><a href="/index.php?option=login" align="center">Already have an account??</a></div>
      </div>
